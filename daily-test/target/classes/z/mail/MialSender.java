...
public class MialSender {
        ...
        private static final String sendUserName = "zhangzh@poinetech.com";// 发送邮件需要连接的服务器的用户名

        private static final String sendPassword = "zhangzh123";// 发送邮件需要连接的服务器的密码

        private static final String sendProtocol = "smtp";// 发送邮件使用的端口

        private static final String sendHostAddress = "smtp.ym.163.com";// 发送邮件使用的服务器的地址
